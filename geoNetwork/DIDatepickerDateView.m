...
const CGFloat kDIDatepickerItemWidth = 46.*5/4;  //THIS MODIFIES WIDTH
const CGFloat kDIDatepickerSelectionLineWidth = 51.*5/4; //TODO makes this dependant on number of days
